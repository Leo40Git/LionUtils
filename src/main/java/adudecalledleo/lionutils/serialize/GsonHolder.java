...
public final class GsonHolder {
    ...
    private static final ExcludeStrategy EXCLUDE_STRATEGY_SERIALIZE = new ExcludeStrategy(
            Exclude.Type.FROM_SERIALIZATION);
    private static final ExcludeStrategy EXCLUDE_STRATEGY_DESERIALIZE = new ExcludeStrategy(
            Exclude.Type.FROM_DESERIALIZATION);
     ...
     * <li>{@linkplain GsonBuilder#serializeSpecialFloatingPointValues() Support for serializing special floating point
     * values.}</li>
